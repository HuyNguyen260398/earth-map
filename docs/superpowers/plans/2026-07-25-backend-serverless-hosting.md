...
jobs:
  ...
  terraform:
    ...
    steps:
      ...
      # Module-level plan tests use a mocked provider and need no credentials,
      # so they run before the role is assumed.
  ...
  deploy:
    ...
    steps:
      ...
      - name: Capture stack outputs
        ...
        run: |
          {
            echo "site_bucket=$(terraform output -raw site_bucket_name)"
